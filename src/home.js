    ...
    <Container>
      <Row>
        <Col xs={10} md={6} className='d-flex align-content-center flex-wrap'>
            <div><h2>Professional WordPress Themes & Website Templates for any project</h2></div>
            <p className='fs-5'>Discover thousands of easy to customize themes, templates & CMS products, made by world-class developers.</p>
      ...
      <div class="row row-cols-1 row-cols-md-3 g-3 ms-1 mt-2">
        <Cards title={'WordPress Themes'} pragraph={'Email, newsletter and landing page.'}/>
        <Cards title={'eCommerce Templates'} pragraph={'Over 1,700 CMS website templates'}/>
        <Cards title={'Site Templates'} pragraph={'Blogger templates and themes'}/>
      </div>
