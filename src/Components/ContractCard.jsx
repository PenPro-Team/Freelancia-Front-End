    ...
    <Card className="mb-4 contract-card">
      ...
      <Card.Body>
        <Row>
          <Col md={8}>
            <p>
              <strong>{t("contracts.deadline")}:</strong> {contract.deadline}{" "}
              {t("contracts.days")}
            </p>
            <p>
              <strong>{t("contracts.budget")}:</strong> ${contract.budget}
            </p>
            <p>
              <strong>{t("contracts.created")}:</strong>{" "}
          ...
          <Col md={4}>
            {current_user.user.role === "client" ? (
              <div
                className="freelancer-info text-center"
      ...
      <Card.Footer className="d-flex justify-content-end">
        <Button
          onClick={() =>
            navigate(`/Freelancia-Front-End/contractDetails/${contract.id}`)
          }
