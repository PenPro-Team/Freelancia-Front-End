            ...
            <Row className="justify-content-center mt-5">
                <Col md={24}>
                    <Card className="shadow-lg p-3 mb-5 bg-white rounded">
                                ...
                                <div>
                                    <div className='d-flex flex-wrap flex-column align-items-center mb-4'>
                                        <img
                                            ...
                                            src={personalImg}
                                        />
                                        <Card.Title className="text-center h3">{userData.firstName + " " + userData.lastName}</Card.Title>
                                        <div><RateStars rating={3} /></div>
                                    </div>
                                    <p>
                                    ...
                                    <p className='w-50'>
                                        <strong className='me-2'>
                                            <MdOutlineDriveFileRenameOutline color='blue' size="2rem" /> Description:
                                        </strong>
                        ...
                        <Link to={`/Freelancia-Front-End/Dashboard/edit/${userData.id}`}>Edit Information</Link>
                    </Card>
                </Col>
            </Row>
        </>
