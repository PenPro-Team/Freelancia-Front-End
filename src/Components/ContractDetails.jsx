...
const ContractDetails = () => {
    ...
    const handleAcceptOrDeclineContract = (e) => {
        ...
        .then(() => {
            ...
            setContract((prevContract) => ({ ...prevContract, contract_state: newState }));
            setLoading(false);
        })
        .catch((error) => {
    ...
    const handleSubmitWork = (e) => {
        ...
        if (description === '' && files.length === 0) {
            setValidationError('Please provide either a description or upload files (or both).');
            return;
        }
        ...
        <div className="container my-4">
            ...
            <div className="card shadow ">
                <div className="card-header d-flex justify-content-between align-items-center">
                    ...
                    <span className={`badge ${contract.contract_state === 'Accepted' ? 'bg-success' :
                        contract.contract_state === 'pending' ? 'bg-warning' :
                            contract.contract_state === 'Completed' ? 'bg-info' : contract.contract_state === 'canceled' ? 'bg-danger' : 'bg-secondary'}`}>
                ...
                <div className="card-body">
                    ...
                    <div className="mb-4">
                        ...
                        <p className="mb-1"><strong>Deadline:</strong> {contract.deadline} Days</p>
                    </div>
                    ...
                    {contract.contract_state === 'Accepted' && current_user.user.role === "freelancer" &&
                            ...
                            <div className="mb-4 mt-5">
                                ...
                                <div className="card">
                                    <div className="card-body">
                                        ...
                                        <form onSubmit={handleSubmitWork} className="needs-validation">
                                            <div className="mb-3">
                                                <label htmlFor="workDescription" className="form-label">Description</label>
                                                <textarea
                                            ...
                                            <div className="mb-3">
                                                <label htmlFor="workFiles" className="form-label">Upload Files</label>
                                                <input
                                                    type="file"
                                                    className="form-control"
                                                    id="workFiles"
                                                    ...
                                                    multiple
                                                />
                                                <div className="form-text">You can select multiple files. Either description or files must be provided.</div>
                                            </div>

                                            <button type="submit" className="btn btn-primary">Submit Work</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                    ...
                    {contract.contract_state === 'Accepted' && (
                        <div className="mb-4 mt-4">
                            ...
                            <div className="card">
                                <div className="card-body">
                                    {contract.attachments && contract.attachments.files?.length > 0 ? (
                                                        ...
                                                        return (
                                                            ...
                                                            >
                                                                <span className="badge bg-light text-dark me-2 p-2 mb-2 d-inline-block">
                                                                    <i className={`bi ${iconClass} me-1`}></i> {fileName}
                                                                </span>
                                                            </a>
                                                        );
                                                    })}
                                        ...
                                        <p className="text-muted">No work has been submitted yet.</p>
                                    )}
                                </div>
                            </div>
                        </div>
                    ...
                    {/* Contract Actions Section */}
                                        ...
                                        {contract.contract_state === 'Accepted' && current_user.user.role === "client" && current_user.user.user_id === contract.client_details.id && (
                                            <div className="d-flex justify-content-end mt-4">
                                                ...
                                                {(() => {
                                                    ...
                                                    return (
                                                        <button 
                                                            ...
                                                            title={deadlinePassed ? "Cancel Contract" : "Cannot cancel until deadline passes"}
                                                        >
                                                            Cancel Contract
                                                        </button>
                                                    );
